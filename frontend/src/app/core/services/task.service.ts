...
export class TaskService {
  ...
  // CORRECTION BUG : PATCH + /status (pas PUT sur /tasks/{id})
  updateStatus(id: number, status: string): Observable<Task> { return this.http.patch<Task>(`${this.API}/tasks/${id}/status`, { status }); }
